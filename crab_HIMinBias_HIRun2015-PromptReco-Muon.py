...
config.General.requestName = 'HIMinimumBias1_HIRun2015-PromptReco-v1_Muon'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'skimHIMB_Muon.py'
...
config.Data.outputDatasetTag = 'HIMinBias_v1_Muon'
...
### 2
config.General.requestName = 'HIMinimumBias2_HIRun2015-PromptReco-v1_Muon'
