...
config.General.requestName = 'HIHardProbes_HIRun2015-PromptReco-v5_DCS'
...
config.Data.runRange = '262768-263758'
config.Data.publication = True
config.Data.outputDatasetTag = 'HIHardProbes_FullTrackSkim2015_v5_DCS'
